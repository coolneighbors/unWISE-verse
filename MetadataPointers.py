...
def generate_VizieR_url(RA, DEC,FOV):
    SIMBAD_template_url = "https://vizier.u-strasbg.fr/viz-bin/VizieR?-c={}+{}&-c.bs={}x{}&-out.add=_r&-out.add=_RAJ%2C_DEJ&-sort=_r&-to=&-out.max=20&-meta.ucd=2&-meta.foot=1&-oc.form=d"
    return SIMBAD_template_url.format(RA, DEC, FOV, FOV)
